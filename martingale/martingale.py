...
def experiment_1_2and3():
    ...
    plt.title("Figure 2: Mean winnings over 1000 episodes of 1000 spins with infinite bankroll")
    plt.xlabel("Spin")
    ...
    plt.plot(bolinger1, label="STD Add")
    plt.plot(bolinger2, label="STD Sub")
    plt.title("Figure 3: Median winnings over 1000 episodes of 1000 spins with infinite bankroll")
    plt.xlabel("Spin")
...
def experiment_1_4and5():
    ...
    plt.plot(bolinger1, label="STD Add")
    plt.plot(bolinger2, label="STD Sub")
    plt.title("Figure 4: Mean winnings over 1000 episodes of 1000 spins with finite bankroll")
    plt.xlabel("Spin")
    plt.ylabel("Mean Winning")
    plt.xlim(0, 300)
    plt.ylim(-256, 100)
    ...
    plt.plot(bolinger1, label="STD Add")
    plt.plot(bolinger2, label="STD Sub")
    plt.title("Figure 5: Median winnings over 1000 episodes of 1000 spins with finite bankroll")
    plt.xlabel("Spin")
    plt.ylabel("Median Winning")
    plt.xlim(0, 300)
    plt.ylim(-256, 100)
